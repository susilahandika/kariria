...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview @yield('setting', '')">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li class="@yield('cprofile', '')"><a href="{{ route('cprofiles.index') }}"><i class="fa fa-circle-o"></i> Company Profile</a></li>
                    <li class="@yield('weight', '')"><a href="{{ route('weights.index') }}"><i class="fa fa-circle-o"></i> Bobot</a></li>
                </ul>
            </li>
        </ul>
    </section>
