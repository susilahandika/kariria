...
<div class="row">
    <div class="col-md-3 column margintop20">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="{{ route('references.index') }}" class="@yield('active_reference', '')"><span class="glyphicon glyphicon-chevron-right"></span> Referensi</a></li>
            {{-- <li><a href="#"><span class="glyphicon glyphicon-chevron-right"></span> Prestasi</a></li> --}}
            <li><a href="{{ route('certificates.index') }}" class="@yield('active_certificate', '')"><span class="glyphicon glyphicon-chevron-right"></span> Sertifikat</a></li>
            <li><a href="{{ route('languages.index') }}" class="@yield('active_language', '')"><span class="glyphicon glyphicon-chevron-right"></span> Bahasa</a></li>
