    ...
    <div class="container">
        <div class="col-md-3 column margintop20">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="{{ route('profile') }}" class="@yield('active_profile', '')"><span class="glyphicon glyphicon-chevron-right"></span> Identitas Diri</a></li>
                <li><a href="{{ route('education') }}" class="@yield('active_education', '')"><span class="glyphicon glyphicon-chevron-right"></span> Pendidikan</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-chevron-right"></span> Preferensi</a></li>
                <li><a href="{{ route('skill') }}" class="@yield('active_skill', '')"><span class="glyphicon glyphicon-chevron-right"></span> Kemampuan</a></li>
                <li><a href="#"><span class="glyphicon glyphicon-chevron-right"></span> Pengalaman Kerja</a></li>
